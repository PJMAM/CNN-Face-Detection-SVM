...
alignment = AlignDlib('D:\GITHUB\CNN-Face-Detection-SVM\Buoc3\models\shape_predictor_68_face_landmarks.dat')

nn4_small2_pretrained = create_model()
nn4_small2_pretrained.load_weights('D://GITHUB//CNN-Face-Detection-SVM//Buoc3//weights//nn4.small2.v1.h5')

svc = joblib.load('svc.pkl')

mydict = ['BanKy','BanNinh','BanThanh','ThayDuc','Vinh']
...
class Main(Frame):
    ...
    def onRecognition(self):
        ...
        cv2.namedWindow("ImageIn", cv2.WINDOW_AUTOSIZE)
        cv2.imshow("ImageIn"+str(type(img_test)), imgin )
